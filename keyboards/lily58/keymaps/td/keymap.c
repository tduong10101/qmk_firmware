 ...
 * |      |      |      |      |      |      |-------|    |-------|  -  |   =  |   [  |   ]  |   \  |      |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   |  LGUI| LAlt |LOWER | / Enter /       \Space \  | Del  | RAISE|RCTRL |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
[_LOWER] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, _______, TG(_GAME), _______, KC_MINS, KC_EQL, KC_LBRC, KC_RBRC, KC_BSLS, XXXXXXX,
...
[_GAME] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, _______,                    _______, _______, _______, _______, _______, _______,
  _______, _______, _______, _______, _______, _______,                    _______, _______, _______, _______, _______, _______,
  _______, _______, _______, _______, _______, _______, TG(_GAME), KC_ENT, _______, _______, _______, _______, _______, _______,
                             _______, _______, MO(_GAMEL),  KC_SPC, _______, _______, _______, _______
),
[_GAMEL] = LAYOUT(
  KC_GRV, _______, _______, _______, _______, _______,                   _______, _______, _______,_______, _______, _______,
  KC_CAPS,   KC_1,    KC_2,    KC_3,  KC_DLR, KC_PERC,                   KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_TILD,
  _______,   KC_4,    KC_5,    KC_6, _______,    KC_5,                     KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    _______,

  _______, _______, _______, _______, _______, _______, TG(_GAME), _______, KC_UNDS, KC_EQL, KC_LBRC, KC_RBRC, KC_BSLS, XXXXXXX,
                             _______, _______, MO(_GAMEL), _______, _______, KC_DEL, _______, _______
),
/* ADJUST
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
